...
$(function() {
	  ...
	  $("#btn-summit").click(function(){
			if($("#option").val()=!null){
				sock.send("${loginuser}"+"님이"+($("#specifictask").val())+"를"
				+($("#option").val())+"에게 배정하셨습니다");
			}
	  });	  
...
<section id="main-content">
   <section class="wrapper">
      ...
      <div class="col-lg-3 ds" style="float: right;" id="test">
         ...
         <h3>세부업무 설정</h3>
         <div id="specifictask" value="a"/>
         <%-- <input type="text" name="specifictask_cont" value="${}" }> --%>
            ...
            <form class="form-horizontal style-form" method="get">
               <div class="form-group">
                  ...
                  <select name="memberlist">
                     <option value="" selected="selected" id="option">멤버선택</option>   
