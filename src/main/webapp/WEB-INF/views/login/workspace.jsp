...
<%-- 		        	<c:forEach items="{workspacelist}" var="WorkspaceDTO">
		        		<a href="main.htm?workspace="${workspaceDTO.workspace_name}" class="btn btn-default btn-lg btn-block">
		        			${workspaceDTO.workspace_name}
