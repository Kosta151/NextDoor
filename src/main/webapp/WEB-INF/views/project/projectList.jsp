...
<section id="main-content">
	<section class="wrapper site-min-height">
		<h2>
			<i class="fa fa-angle-right"></i> Workspace : ${workspaceinfo}
		</h2>
		<div class="row mt">
			<div class="col-lg-12">
				<div class="row">
					...
					<c:forEach items="${projectlist}" var="list">
						<div class="col-md-4 col-sm-4 mb">
							<div class="grey-panel pn donut-chart">
												...
												<div class="box-tools pull-right">
													<div class="btn-group">
														<button type="button" class="close" data-toggle="dropdown"
															onclick="location.href='projectUpdate.htm?project_no=${list.project_no}'">
															<i class="fa fa-wrench"
																style="font-size: 17px; margin-right: 10px;"></i>
														</button>
													</div>
													<button type="button" class="close" data-widget="remove">
														<i class="fa fa-times"
															style="font-size: 17px; margin-right: 10px;"
															onclick="location.href='projectDelete.htm?project_no=${list.project_no}'"></i>
													</button>
												</div>
											</c:when>
										</c:choose>
								...
								<div
									onclick="location.href='task.htm?project_no=${list.project_no}'">
							...
							<form action="insertProject.htm" method="post" id="projectform">
								<div class="modal-body">
									...
									<input type="text" name="project_name" id="project_name"
										placeholder="project명을 입력해주세요." autocomplete="off"
										class="form-control placeholder-no-fix"> <br>
								</div>
								<div class="modal-footer centered">
									<button type="button" class="btn btn-warning" id="btn">생성
									</button>
